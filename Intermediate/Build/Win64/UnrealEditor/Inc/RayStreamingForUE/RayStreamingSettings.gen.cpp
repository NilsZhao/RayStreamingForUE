...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_URayStreamingSettings_Statics::NewProp_TestUrl = { "TestUrl", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(URayStreamingSettings, TestUrl), METADATA_PARAMS(Z_Construct_UClass_URayStreamingSettings_Statics::NewProp_TestUrl_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URayStreamingSettings_Statics::NewProp_TestUrl_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_URayStreamingSettings_Statics::NewProp_ReconnectInterval = { "ReconnectInterval", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(URayStreamingSettings, ReconnectInterval), METADATA_PARAMS(Z_Construct_UClass_URayStreamingSettings_Statics::NewProp_ReconnectInterval_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URayStreamingSettings_Statics::NewProp_ReconnectInterval_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_URayStreamingSettings_Statics::NewProp_bUseRayStreamingInput = { "bUseRayStreamingInput", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(URayStreamingSettings), &Z_Construct_UClass_URayStreamingSettings_Statics::NewProp_bUseRayStreamingInput_SetBit, METADATA_PARAMS(Z_Construct_UClass_URayStreamingSettings_Statics::NewProp_bUseRayStreamingInput_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URayStreamingSettings_Statics::NewProp_bUseRayStreamingInput_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_URayStreamingSettings_Statics::NewProp_bEnableWebCommand = { "bEnableWebCommand", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(URayStreamingSettings), &Z_Construct_UClass_URayStreamingSettings_Statics::NewProp_bEnableWebCommand_SetBit, METADATA_PARAMS(Z_Construct_UClass_URayStreamingSettings_Statics::NewProp_bEnableWebCommand_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URayStreamingSettings_Statics::NewProp_bEnableWebCommand_MetaData)) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_URayStreamingSettings_Statics::NewProp_PermittedConsoleCommands_Inner = { "PermittedConsoleCommands", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_URayStreamingSettings_Statics::NewProp_PermittedConsoleCommands = { "PermittedConsoleCommands", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(URayStreamingSettings, PermittedConsoleCommands), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_URayStreamingSettings_Statics::NewProp_PermittedConsoleCommands_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URayStreamingSettings_Statics::NewProp_PermittedConsoleCommands_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_RayStreamingForUE_Source_RayStreamingForUE_Public_RayStreamingSettings_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_RayStreamingForUE_Source_RayStreamingForUE_Public_RayStreamingSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URayStreamingSettings, URayStreamingSettings::StaticClass, TEXT("URayStreamingSettings"), &Z_Registration_Info_UClass_URayStreamingSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URayStreamingSettings), 1777417263U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_RayStreamingForUE_Source_RayStreamingForUE_Public_RayStreamingSettings_h_282875851(TEXT("/Script/RayStreamingForUE"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_RayStreamingForUE_Source_RayStreamingForUE_Public_RayStreamingSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_RayStreamingForUE_Source_RayStreamingForUE_Public_RayStreamingSettings_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
